...
1 - Fitting different calibration curves to PhantomExtract results and performing weight tests [Phantom_Fittings.py](..blob/main/CoralWeightTests/Phantom_Fittings.py)
